...
Following the groupings of functions from the [stringr cheat sheet](https://github.com/rstudio/cheatsheets/blob/master/strings.pdf), these are the base equivalents to stringr functions.
...
## Example from https://techoverflow.net/2012/11/10/r-count-occurrences-of-character-in-string/
...
lapply(unlist(str_split("aecfg", "")), function(x) {
  grepl(x, letters)
})
